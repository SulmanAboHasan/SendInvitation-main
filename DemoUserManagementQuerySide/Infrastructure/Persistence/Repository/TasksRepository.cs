...
{
    public class TasksRepository<T>(InvitationDbContext context) : ITasksRepository<T> where T : class
    {
        ...
        public async Task<IEnumerable<T>> GetAllAsync(Expression<Func<T, bool>>? filter = null, string? includeProperties = null, int? page = null, int? size = null)
        {
