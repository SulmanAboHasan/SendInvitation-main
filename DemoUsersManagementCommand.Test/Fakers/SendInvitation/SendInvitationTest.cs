...
namespace DemoUsersManagementCommand.Test.Fakers.SendInvitation
{
    public class SendInvitationTest(WebApplicationFactory<Program> factory,
        ITestOutputHelper helper) : IClassFixture<WebApplicationFactory<Program>>
    {
